...
ACLOCAL = ${SHELL} /root/Pulpit/SyMGIZA/MGIZA/missing --run aclocal-1.10
AMTAR = ${SHELL} /root/Pulpit/SyMGIZA/MGIZA/missing --run tar
AUTOCONF = ${SHELL} /root/Pulpit/SyMGIZA/MGIZA/missing --run autoconf
AUTOHEADER = ${SHELL} /root/Pulpit/SyMGIZA/MGIZA/missing --run autoheader
AUTOMAKE = ${SHELL} /root/Pulpit/SyMGIZA/MGIZA/missing --run automake-1.10
AWK = mawk
CC = gcc
...
LTLIBOBJS = 
MAINT = #
MAKEINFO = ${SHELL} /root/Pulpit/SyMGIZA/MGIZA/missing --run makeinfo
MKDIR_P = /bin/mkdir -p
OBJEXT = o
PACKAGE = mgiza
PACKAGE_BUGREPORT = 
...
STRIP = 
VERSION = 1.0
abs_builddir = /root/Pulpit/SyMGIZA/MGIZA
abs_srcdir = /root/Pulpit/SyMGIZA/MGIZA
abs_top_builddir = /root/Pulpit/SyMGIZA/MGIZA
abs_top_srcdir = /root/Pulpit/SyMGIZA/MGIZA
ac_ct_CC = gcc
ac_ct_CXX = g++
am__include = include
am__leading_dot = .
...
install_sh = $(SHELL) /root/Pulpit/SyMGIZA/MGIZA/install-sh
